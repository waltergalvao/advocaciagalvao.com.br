  ...
  return {
    DEFAULT: {
      css: {
        ...
        "--tw-prose-links-hover": theme("colors.slate.700"),
        "--tw-prose-links-underline": theme("colors.slate.800 / 0.3"),
        "--tw-prose-bold": theme("colors.slate.800"),
        "--tw-prose-counters": theme("colors.slate.500"),
        "--tw-prose-bullets": theme("colors.zinc.600"),
        "--tw-prose-hr": theme("colors.slate.800 / 0.05"),
        ...
        "--tw-prose-code-ring": theme("colors.slate.800 / 0.1"),
