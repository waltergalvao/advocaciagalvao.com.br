...
export function PracticeAreas() {
  const primaryAreas = [
    {
      ...
      description:
        "Atuação jurídica ágil para reverter bloqueios e suspensões de contas de vendedores nos principais marketplaces do país, restabelecendo as vendas o quanto antes.",
      icon: <IconUserX className="w-8 h-8" stroke={1.5} />,
    },
    {
      title: "Retenção de Saldo",
      description:
        "Medidas extrajudiciais e judiciais para a liberação imediata de valores retidos arbitrariamente por plataformas digitais sob a justificativa de reserva de segurança.",
      icon: <IconCoins className="w-8 h-8" stroke={1.5} />,
    },
    {
      title: "Anúncios Derrubados",
      description:
        "Contestações técnicas para restabelecer listagens, anúncios e produtos campeões de vendas (best-sellers) desativados indevidamente ou sem prévio aviso.",
      icon: <IconTrendingDown className="w-8 h-8" stroke={1.5} />,
    },
    {
      title: "Propriedade Intelectual",
      description:
        "Ampla assessoria em denúncias de marca registrada, patentes, direitos de imagem e combate a falsas notificações de contrafação (programas como PPI e Brand Protection).",
      icon: <IconAward className="w-8 h-8" stroke={1.5} />,
    },
    {
      title: "Estoque Retido ou Descarte",
      description:
        "Ações coordenadas e eficientes para evitar a retenção ilegal de sua mercadoria ou a ameaça de descarte unilateral do seu estoque nos modelos Fulfillment.",
      icon: <IconPackageOff className="w-8 h-8" stroke={1.5} />,
    },
    {
      title: "Consultoria Preventiva para E-commerce",
      description:
        "Análise estratégica dos termos de uso, auditoria de processos de compliance e assessoria de contratos para blindar permanentemente sua operação online.",
      icon: <IconFileText className="w-8 h-8" stroke={1.5} />,
    },
  ];
  ...
  const highlightedArea = {
    ...
    description:
      "Cada minuto com anúncios desativados ou contas bloqueadas custa caro. Conduzimos as demandas com o máximo de agilidade, elaborando defesas personalizadas, sem respostas genéricas ou amadoras, focando na reativação rápida da sua operação comercial.",
    icon: <IconBolt className="w-8 h-8" stroke={1.5} />,
  };
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-base md:text-lg text-gray-500 mt-4 leading-relaxed max-w-2xl mx-auto">
            Deixe as burocracias sob nossa responsabilidade e proteja de forma
            ativa o ritmo de vendas do seu negócio online.
          </p>
        </div>
