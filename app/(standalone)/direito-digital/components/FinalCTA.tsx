    ...
    <section className="py-24 bg-navy-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center border border-gold-500/20 p-8 md:p-16 rounded-3xl backdrop-blur-sm bg-white/5">
          ...
          >
            Sua operação no marketplace precisa de uma análise jurídica
            estratégica?
          </motion.h2>

          <p className="text-xl text-white/70 mb-10 leading-relaxed">
            Se sua conta foi suspensa, seu saldo está retido ou sua empresa
            enfrenta problemas com marketplaces, solicite uma análise inicial e
          ...
          <p className="mt-8 text-white/40 text-sm italic">
            Fale com o especialista e garanta a segurança da sua operação
            digital.
          </p>
        </div>
      </div>
