      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-sm md:text-base mt-2 max-w-xl mx-auto">
            Garantimos sigilo profissional absoluto e integridade corporativa em
            cada análise.
          </p>
        </div>
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {reviews.map((review, index) => (
            ...
            >
              <IconQuote className="absolute top-6 right-8 w-12 h-12 text-gold-500/10" />
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  <div className="flex gap-1 mb-5">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <span key={s} className="text-gold-500 text-lg">
                        ★
                      </span>
                    ))}
                  </div>
                ...
                <div className="flex items-center gap-3.5 pt-4 border-t border-gray-100">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gold-600 text-[10px] uppercase font-bold tracking-widest mt-1">
                      {review.type}
                    </span>
                  </div>
                </div>
        ...
        <div className="md:hidden relative max-w-md mx-auto px-4">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div className="flex items-center gap-3.5 pt-4 border-t border-gray-100">
                  <div className="w-11 h-11 rounded-full bg-gold-500/10 border border-gold-500/20 text-gold-600 flex items-center justify-center font-bold text-base select-none shrink-0">
                    ...
                    {reviews[currentIndex].name.split(" ")[1]?.[0] || ""}
                  </div>
                  <div className="flex flex-col">
                    <span className="font-bold text-navy-900 leading-tight">
          ...
          <div className="flex justify-center items-center gap-6 mt-8">
            ...
            >
              <IconChevronLeft className="w-5 h-5" stroke={1.5} />
            </button>
              ...
              {reviews.map((_, i) => (
                <div
                  ...
                  className={`w-1.5 h-1.5 rounded-full transition-all ${
                    i === currentIndex ? "bg-gold-500 w-3" : "bg-gray-300"
                  }`}
                />
              ))}
            </div>
            ...
            >
              <IconChevronRight className="w-5 h-5" stroke={1.5} />
            </button>
          </div>
