...
export function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[100svh] flex items-center overflow-hidden pt-[76px]"
    >
      {/* Background Images */}
      <picture className="absolute inset-x-0 top-[76px] bottom-0 z-0">
      ...
      {/* Overlay */}
      <div className="absolute inset-x-0 top-[76px] bottom-0 bg-navy-900/50 md:bg-gradient-to-r md:from-navy-900/90 md:via-navy-900/60 md:to-transparent z-10" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20 pt-20">
        <div className="max-w-3xl">
          ...
          >
            Atuação jurídica focada em vendedores, lojistas e operações de
            e-commerce que enfrentam bloqueios, retenções, denúncias e
            restrições em plataformas digitais.
          </motion.p>
