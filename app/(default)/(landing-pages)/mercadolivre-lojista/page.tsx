...
import ProblemasMercadoLivre from "@/components/marketplaces/mercadolivre/problemas-mercadolivre";
import { CtaButton } from "@/components/cta-button";
import { Avaliacoes } from "@/components/avaliacoes";
import Qualidades from "@/components/qualidades";
import Quote5 from "@/components/assets/quote-5.png";
import Quote6 from "@/components/assets/quote-6.png";
import Quote7 from "@/components/assets/quote-7.png";
import Quote8 from "@/components/assets/quote-8.png";
import { Quote } from "@/components/quote";
import ButtonCta from "@/components/ui/button-cta";
import HeroMercadoLivreV2 from "@/components/marketplaces/mercadolivre/hero-mercadolivre-v2";

export const metadata = {
  title: "Mercado Livre | Galvão Advocacia",
  description:
    "Conta bloqueada no Mercado Livre? Saiba como reverter! Com análise especializada, podemos recorrer e adotar medidas legais para desbloquear sua conta e recuperar seu prejuízo.",
};
    ...
    <>
      ...
      <div className="mt-32 max-w-6xl mx-4 md:mx-auto border-4 border-dashed border-slate-600 p-12 rounded-lg shadow-lg text-center">
        <h2 className="h2 font-playfair-display font-extrabold text-slate-800 mb-4">
          Conta bloqueada no Mercado Livre? <br />
          Saiba como reverter!
        </h2>
      ...
      <section className="mt-32 px-4 md:px-0">
        ...
        <div className="mt-12 flex flex-col gap-4">
          ...
          <Quote imageSrc={Quote6} name="Silvia Braga" role="Artesã">
          ...
          >
            &ldquo;O Mercado Livre bloqueou minha conta alegando violação de
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center md:space-x-8">
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <p className="text-lg text-slate-500">
              ...
              Lojistas do Mercado Livre, atuando em casos de contas suspensas ou
