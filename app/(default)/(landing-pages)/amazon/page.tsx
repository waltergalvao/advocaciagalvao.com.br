...
import HeroAmazon from "@/components/marketplaces/amazon/hero-amazon";
import ProblemasAmazon from "@/components/marketplaces/amazon/problemas-amazon";
import { CtaButton } from "@/components/cta-button";
import { Avaliacoes } from "@/components/avaliacoes";
import Qualidades from "@/components/qualidades";
import Quote9 from "@/components/assets/quote-9.png";
import Quote10 from "@/components/assets/quote-10.png";
...
export const metadata = {
  ...
  description:
    "Conta bloqueada na Amazon? Saiba como reverter! Com análise especializada, podemos recorrer e adotar medidas legais para desbloquear sua conta e recuperar seu prejuízo.",
};
    ...
    <>
      ...
      <section className="mt-32 px-4 md:px-0">
        ...
        <div className="mt-12 flex flex-col gap-4">
          <Quote
            imageSrc={Quote9}
            name="Patrícia Garcia"
            role="Microempreendedora"
          >
            &ldquo;Minha conta na Amazon foi suspensa sem explicação, e meu
          ...
          <Quote imageSrc={Quote10} name="Marco Antônio" role="Artesão">
          ...
          >
            &ldquo;A Amazon bloqueou minha conta alegando violação de
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center md:space-x-8">
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <p className="text-lg text-slate-500">
              ...
              Lojistas da Amazon, atuando em casos de contas suspensas ou
          ...
          <div className="py-12 md:py-20 border-t border-slate-50">
            ...
            <ul className="max-w-3xl mx-auto divide-y divide-slate-200">
              <Accordion title="Por que minha conta foi bloqueada?">
                ...
                violações de políticas da Amazon, erros de análise automatizada
