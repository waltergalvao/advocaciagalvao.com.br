    ...
    <section id="metodo" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          {/* Solution Steps */}
          <div>
            <h2 className="text-gold-600 font-bold uppercase tracking-widest text-sm mb-4">A Abordagem</h2>
          ...
          <div className="bg-navy-900 p-8 md:p-12 rounded-lg text-white shadow-xl relative overflow-hidden">
            ...
            <ul className="space-y-4 relative z-10">
              {scenarios.map((item, index) => (
                <li key={index} className="flex items-center gap-3 text-white/80 text-sm md:text-base border-b border-white/5 pb-3">
